    ...
    return (
        <div>
            ...
            <div className='left w-1/2 flex items-start -mt-60 lg:flex-col lg:gap-10 lg:-mt-0 lg:w-[33%]'>
                ...
                <p className='hidden lg:block text-gray-300'>CleverBooks  is an AI-powered supply chain software that provides companies tools for demand forecasting, inventory planning and more. This helps them have the right amount of stock, optimise space and fulfil every order.</p>
            </div>
            <div className='right flex flex-col gap-8 w-[33%]'>
                <h1 className='font-semibold text-lg'>Contact CleverBooks </h1>
                <h1 className='text-gray-300'>sales@getCleverBooks .ai</h1>
